...
public class ItemSelectorByCombinationTest {
    @Test
    public void whenSelectThenReturnsItemsGivingMaximumCost() {
        ...
        var result = new ItemSelectorByCombination().select(50, shipments);
    ...
    public void whenSelectThenReturnsItemsGivingMaximumCost2() {
        ...
        var result = new ItemSelectorByCombination().select(100, shipments);
        assertThat(result.size(), is(2));
